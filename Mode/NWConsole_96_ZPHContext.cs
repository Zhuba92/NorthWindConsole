...
{
    public partial class NWConsole_96_ZPHContext : DbContext
    {
        public NWConsole_96_ZPHContext()
        {
        }

        public NWConsole_96_ZPHContext(DbContextOptions<NWConsole_96_ZPHContext> options)
            : base(options)
        {
        }
